/**
 * 
 * @param {import('xink').RequestEvent} event 
 * @returns {import('xink').MaybePromise<Response>}
 */
 ...
 * 
 * @param {...import('xink').Handle} handlers The chain of `handle` functions
 * @returns {import('xink').Handle}
 */
